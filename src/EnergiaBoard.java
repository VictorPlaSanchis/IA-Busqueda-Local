...
public class EnergiaBoard {
    private static int nCentrals; //numero de centrals
    private static int nGarantitzats; //numero de clients garantitzats
    private static int nNoGarantitzats; //numero de clients no garantitzats
    private static Centrales centrals; //posicions de les centrals
    private static Clientes clients; //posicions dels clients
    ...
    public EnergiaBoard() throws Exception {
        centrals = new Centrales(new int[],);
    ...
    public EnergiaBoard(EnergiaBoard c) {
        int i, j;
