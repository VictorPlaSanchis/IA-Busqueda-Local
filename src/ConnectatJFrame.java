...
public class ConnectatJFrame extends javax.swing.JFrame {
    ...
    */}
    ...
    private void initComponents() {
        ...
        dibuixCiutatHC = new DibuixCiutat();
        ...
        dibuixCiutatSA = new DibuixCiutat();
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Par�metres de la Ciutat"));
        ...
        mText.setColumns(3);
        mText.setToolTipText("Al�ada de la ciutat");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        estatInicialCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Aleatori (tal com s'han creat)", "Aleatori, centrals amb tres connexions", "Dist�ncia m�nima entre centrals", "Dist�ncia m�nima, centrals amb tres connexions", "Dist�ncia m�nima, amb repetidors" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        ...
        jPanel12.setBorder(javax.swing.BorderFactory.createTitledBorder("Par�metres del Problema"));
        jPanel12.setLayout(new java.awt.GridBagLayout());

        jLabel26.setText("nombre m�xim de repetidors:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridwidth = 5;
        ...
        actualitzarParamsButton.setText("Actualitzar par�metres");
        ...
        panelIniciCiutat.setLayout(new BorderLayout());
        panelIniciCiutat.add(dibuixCiutat1, BorderLayout.CENTER);
        ...
        operadorsInfo.setBackground(UIManager.getDefaults().getColor("Label.background"));
        ...
        heuristicCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Error Total", "Error total + num. repetidors", "Error total x num. repetidors", "(Error total * num. repetidors) / Sum. graus repet.", "(Error total + num. repetidors)*dist. m�xima" }));
        ...
        heuristicInfo.setBackground(UIManager.getDefaults().getColor("Label.background"));
        ...
        infoHC.setBackground(UIManager.getDefaults().getColor("Label.background"));
        ...
        panelIniciCiutat1.setLayout(new BorderLayout());
        panelIniciCiutat1.add(dibuixCiutatHC, BorderLayout.CENTER);
        ...
        infoSA.setBackground(UIManager.getDefaults().getColor("Label.background"));
        ...
        panelIniciCiutat3.setLayout(new BorderLayout());
        panelIniciCiutat3.add(dibuixCiutatSA, BorderLayout.CENTER);
        ...
        info_operadors=op+1;
         switch (op){
             ...
             case 1:
                 ...
                 operadorsInfo.setText("Treure repetidor desconnecta el repetidor de tots els seus ve�ns i els connecta entre ells formant un cam�.");
                 break;
             case 2:
                 operadors = new ConnectatSuccessorFunction3();
                 operadorsInfo.setText("Afegeix repetidor no usat entre un conjunt de nodes, entre 2 i 5, que formin un cam� entre ells. Desconnecta tots els nodes i els connecta directament al repetidor afegit.");
                 break;
             case 3:
                 operadors = new ConnectatSuccessorFunction4();
                 operadorsInfo.setText("Afegeix repetidor entre 2-5 nodes, i tamb� els pot treure.");
                 break;
             case 4:
             ...
             case 5:
                 ...
                 operadorsInfo.setText("Afegir repetidor entre dos nodes, i tamb� moure una aresta existent sense formar bucles.");
                 break;
             case 6:
        ...
        info_heuristic=heu+1;
         switch (heu){
             ...
             case 3:
                 ...
                 heuristicInfo.setText("Minimitza l'error total * els repetidors usats, i a m�s maximitza el sumatori de graus dels repetidors");
                 break;
             case 4:
                 heuristic = new ConnectatHeuristicFunction5();
                 heuristicInfo.setText("Minimitza l'error total + els repetidors usats, i a m�s minimitza la dist�ncia m�xima entre les arestes del graf");
                 break;
             default:
...
// TODO add your handling code here:
    ...
    private boolean comprovarParams() {
        ...
        if (nc + nr > m * n) {
            ...
            error("Els par�metres han de complir alfa > beta > gamma");
            err=true;
        }
        else if (maxrep>nr) {
            error("El nombre m�xim de repetidors no pot excedir el nombre de repetidors existents.");
            err=true;
        }
        if (!err) error(null);
        return err;
    ...
    private void error(String err){
        if (err!=null) {
            ...
            errorLabel.setText(" Pr�ctica de Cerca Local d'IA. Albert S�nchez i Marc Boquet, FIB 2006");
        }
    }
    ...
    private DibuixCiutat dibuixCiutat1;
    private DibuixCiutat dibuixCiutatHC;
    private DibuixCiutat dibuixCiutatSA;
